...
/*
 * Local fork patch notes:
 * - Cross-section fast upward scroll could produce progress jitter and visual flicker
 *   in scrolled-continuous mode on mobile devices.
 * - See vendor/epubjs/LOCAL_PATCHES.md for root cause and patch details.
 */
